...
int	main()
{
	...
	printf("5.%-3p ", 16);
	printf("6.%-4p ", 17);
	printf("7.%-9p %-10p ", LONG_MIN, LONG_MAX);
	printf("8.%-11p %-12p ", INT_MIN, INT_MAX);
	printf("9.%-13p %-14p ", ULONG_MAX, -ULONG_MAX);
	printf("10.%-1p %-2p ", 0, 0);
	...
	ft_printf("5.%-3p ", 16);
	ft_printf("6.%-4p ", 17);
	ft_printf("7.%-9p %-10p ", LONG_MIN, LONG_MAX);
	ft_printf("8.%-11p %-12p ", INT_MIN, INT_MAX);
	ft_printf("9.%-13p %-14p ", ULONG_MAX, -ULONG_MAX);
	ft_printf("10.%-1p %-2p ", 0, 0);
